...
const en = {
    ...
    'summary': 'Summary',
    'up': 'Up',
    'version-text': '* InsanityMeetsHH / Twitch Chat Bot {{0}}',
    'version-text-ahead': '* Software is newer than latest release ({{0}})',
    'version-text-behind': '* Software update available ({{0}})\r\n* Visit https://github.com/InsanityMeetsHH/twitch-chatbot for more information',
...
const de = {
    ...
    'version-text-behind': '* Software update verfügbar ({{0}})\r\n* Besuche https://github.com/InsanityMeetsHH/twitch-chatbot für mehr Informationen',
