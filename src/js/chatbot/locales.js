...
const en = {
    ...
    'channels-loaded': '* All Channels are loaded ({{0}})',
    ...
    'no': 'No',
    'oauth-undefined': 'OAuth token is undefined',
    ...
    'viewer-count-wo-title': '-- No Title --',
    'vote_one': 'Vote',
    'vote_other': 'Votes',
    'whisper-incoming': '* Whisper from {{0}}: {{1}}',
    'winner': 'Winner',
    'yes': 'Yes',
...
const de = {
    ...
    'channels-loaded': '* Alle Kanäle wurden geladen ({{0}})',
    ...
    'no': 'Nein',
    'oauth-undefined': 'OAuth-Token fehlt',
    'playlist_one': 'Playlist',
    ...
    'viewer-count-wo-title': '-- Kein Titel --',
    'vote_one': 'Stimme',
    'vote_other': 'Stimmen',
    'whisper-incoming': '* Whisper von {{0}}: {{1}}',
    'winner': 'Gewinner',
    'yes': 'Ja',
